...
class EVCl extends CarCl2 {
  // ES6 classes
  #charge; // # for Private method

  constructor(make, speed, charge) {
    super(make, speed);
    this.#charge = charge; // # for Private method
  }
...
console.log(rivian);
// console.log(rivian.#charge); // cant be accessible bs of a private method
rivian // Chaining!
  .accelerate()
  .accelerate()
  .accelerate()
